				...
				<div class="col-sm-12">
					<div class="card card-light card-outline">
						<div class="card-header" style="height: 45px; padding: 10px;">
							<div class="row">
			            	<div class="col-md-9">
								<h3 class="card-title" style="padding-left: 10px; padding-top: 5px;">
						...
						<table class="table table-head-fixed table-bordered">
                			...
                			<c:forEach items="${subjectStudyPlanWeekList }" var="studyPlan">
								...
								<c:if test="${empty dateStudyPlanWeekList }" >	
								 <tr>
										<td style="padding: 0px; margin: 0px;"><input class="subject" type="text" name="text" size="20" style="width:100%; height:53px; border: 0; text-align: center;" value=""></td>
										<td style="padding: 0px; margin: 0px;"><textarea class="SDetail" name="content" rows="10" style="width:100%; height:53px; border: 0; resize: none;"></textarea></td>
						...
						<table class="table table-head-fixed table-bordered">
							...
							<c:if test="${empty dateStudyPlanWeekList }" >
									<tr>
										...
										<td style="padding: 0px; margin: 0px;"><textarea class="DDetail" name="content" rows="10" style="width:100%; height:53px; border: 0; resize: none;" ></textarea></td>
